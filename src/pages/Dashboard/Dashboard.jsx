...
const Dashboard = () => {
    ...
    const { loggedUser,
        ...
        fetchWebcode,
        capStone,
        fetchCapStone,handleHead} = useContext(DataContext);
            ...
            <div className='activities__box container'>
                ...
                <div className='problem__solved gap-5'>
                    <div className="codekata border border-2">
                        ...
                        <div className="score text-center p-2">
                            {
                                webCode ?
                                    webCode.score :
                                    "Not Submitted"
                    ...
                    <div className="webkata border border-2">
                        ...
                        <div className="score text-center p-2">{loggedUser.mockInterview}</div>
                        <div className='text-center mb-2 '>
