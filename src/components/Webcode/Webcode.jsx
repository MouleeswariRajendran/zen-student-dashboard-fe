                            ...
                            <div className="mx-1 secondaryGreyTextColor">
                                <div className="col-12">
                                    ...
                                    <div className="mx-2 py-1 px-2 ">
                                        <p>Implement the BULKMAILER using async/await with fetch.</p>
                                        ...
                                        <ul>
                                            ...
                                            <li>Use fetch() to get the data from BULKMAILER</li>
                                        ...
                                        <p>https://bulkmailer.io/</p>
                                        <p>https://bulkmailer.io/#responses/</p>
